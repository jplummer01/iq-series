...
Amanda Silver opens the discussion on Knowledge Bases and the shift from isolated pipelines to reusable knowledge.

### 💬 Tech Talk

Pamela Fox and Matt Gotteiner walk through:
- Topic-centric Knowledge Bases
- Demonstrating a multi-source query path
